...
public final class DrawerActions {
  ...
  private abstract static class DrawerAction implements ViewAction {
    ...
    public final void perform(UiController uiController, View view) {
      ...
      Object tag = drawer.getTag(R.id.androidx_test_espresso_contrib_drawer_layout_tag);
      ...
      if (tag instanceof IdlingDrawerListener) {
        ...
        drawer.setTag(R.id.androidx_test_espresso_contrib_drawer_layout_tag, idlingListener);
      ...
      drawer.setTag(R.id.androidx_test_espresso_contrib_drawer_layout_tag, null);
    }
